...
class LoginPageLocators:
    ...
    PASSWORD_ERROR = (
        By.CSS_SELECTOR, "div.form-group:nth-child(3) > div:nth-child(3)")
...
class TypeOfferPageLocators:
    ...
    NAME_ERROR = (By.CSS_SELECTOR,
                  "div.form-group:nth-child(2) > div:nth-child(3)")
    OFFER_TYPE_EDITED_FROM_TABLE = (
        By.CSS_SELECTOR, "tbody tr:last-child td:nth-child(5)")


class OfferPageLocators:
    OFFER_SUBMIT_BUTTON = (By.TAG_NAME, "button")
    OFFER_NAME = (By.ID, "offer-name")
    OFFER_COMMENT = (By.CLASS_NAME, "redactor-linebreaks")
    OFFER_CONTEXT = (By.ID, "offer-context")
    OFFER_TYPE = (By.ID, "0")
    OFFER_START_DATE = (By.ID, "offer-begins")
    OFFER_REMOVE_START_DATE_BUTTON = (
        By.CSS_SELECTOR, "#offer-begins-datetime > span:nth-child(2)")
    OFFER_FINISH_DATE = (By.ID, "offer-ends")
    OFFER_REMOVE_FINISHT_DATE_BUTTON = (
        By.CSS_SELECTOR, "#offer-ends-datetime > span:nth-child(2)")
...
class TaskPageLocators:
    ...
    LOOK_BUTTON_FROM_TABLE = (
        By.CSS_SELECTOR, "tbody tr:last-child td:last-child a[aria-label='Просмотр']")
    EDIT_BUTTON_FROM_TABLE = (
        By.CSS_SELECTOR, "tbody tr:last-child td:last-child a[aria-label='Редактировать']")
    REMOVE_BUTTON_FROM_TABLE = (
        By.CSS_SELECTOR, "tbody tr:last-child td:last-child a[aria-label='Удалить']")
...
class ParamsPageLocators:
    ...
    OFFER_NAME = (By.CSS_SELECTOR,
                  "div.form-group:nth-child(3) > h3:nth-child(1)")
    PRODUCT_NAME = (By.CSS_SELECTOR,
                    "div.form-group:nth-child(4) > h3:nth-child(1)")
